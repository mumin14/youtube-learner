      ...
      <section className="max-w-[1200px] mx-auto px-6 pt-20 pb-16 md:pt-28 md:pb-24">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
          <div className="flex-1 max-w-[640px]">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-[56px] font-extrabold leading-[1.08] tracking-tight mb-6">
              The missing layer between your scattered materials and real learning
            </h1>
